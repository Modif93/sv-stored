...
`packages/stored` and the docs site in `sites/docs`.
...
- Create `packages/stored/src/lib/utilities/<utility-kebab>/<utility-kebab>.svelte.ts`
- Export it via `packages/stored/src/lib/utilities/<utility-kebab>/index.ts` and append to the
  utilities barrel
